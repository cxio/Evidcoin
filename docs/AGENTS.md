...
> - 当由开发提案生成（或修订）实施方案时（Proposal => Plan），创建 Proposal => Plan 的单向对应表。
...
| `3.Evidence-Design.md` | `5.信用结构.md` | 三种信元（币金、凭信、存证）的完整设计 |
| `4.Script-of-Stack.md` | `6.脚本系统.md` | 栈机制、指令集、执行环境 |
| `5.Transaction.md` | `附.交易.md`<br>`5.信用结构.md`<br>`6.脚本系统.md` | 交易结构、信元编码、脚本验证机制 |
| `6.Checks-by-Team.md` | `附.组队校验.md` | 校验团队架构、首领校验、冗余机制 |
