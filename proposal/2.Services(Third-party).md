# Third-Party Public Services Design Proposal（第三方公共服务设计提案）
...
- **Base Network (基网)**：轻量级 P2P 网络，通过广播搜索机制提供通用节点发现能力。所有其他网络都构建在其之上。基网是 P2P 节点的开放“自由市场”——任意应用节点都可以通过它发现同类节点，或定位所需的服务节点。
...
- 当连接区块链应用节点时，Blockqs 节点会出示自己的区块链地址，以便可能的奖励分配。
...
服务节点在连接应用节点时会出示其区块链地址，使铸造者能够识别可获得奖励的服务接收方。
